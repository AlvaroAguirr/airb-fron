...
const Categories: React.FC<CategoriesProps>= ({
    ...
    return(
        ...
        <div className="pt-3 cursor-pointer pb-6 flex items-center space-x-12">
                      ...
                      <div
                        onClick={()=>setCategory('Village')}
                      className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${dataCategory== 'Village' ? 'border-gray-800': 'border-white'} opacity-60 hover:border-gray-200 hover:opacity-100`}>
